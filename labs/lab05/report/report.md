...
![Случай 1. Решение, полученное на Modelica](image/lab5_1_2.png){#fig:005 width=70%}

- Второй график отражает зависимость x от y:

![Случай 1. График зависимости x от y, полученный на Modelica](image/lab5_1_1.png){#fig:006 width=70%}
...
![Случай 2. Стационарное состояние, полученное на Julia](image/lab5_om_2.png){#fig:007 width=70%}
