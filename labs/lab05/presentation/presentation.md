...
![Случай 1. Решение, полученное на Julia](image/lab04_1_julia.png){#fig:002 width=40%}

## Выполнение на Julia

![Случай 1. Фазовый портрет, полученный на Julia](image/lab04_1_pp_julia.png){#fig:003 width=50%}
...
![Случай 2. Решение, полученное на Julia](image/lab04_2_julia.png){#fig:004 width=40%}

## Выполнение на Julia

![Случай 2. Фазовый портрет, полученный на Julia](image/lab04_2_pp_julia.png){#fig:005 width=50%}
...
![Случай 3. Решение, полученное на Julia](image/lab04_3_julia.png){#fig:006 width=40%}

## Выполнение на Julia

![Случай 3. Фазовый портрет, полученный на Julia](image/lab04_3_pp_julia.png){#fig:007 width=50%}
...
![Случай 1. Решение, полученное на Modelica](image/lab4_1.png){#fig:008 width=50%}

## Выполнение на Modelica

![Случай 1. Фазовый портрет, полученный на Modelica](image/lab4_1_pp.png){#fig:009 width=50%}
...
![Случай 2. Решение, полученное на Modelica](image/lab4_2.png){#fig:010 width=50%}

## Выполнение на Modelica

![Случай 2. Фазовый портрет, полученный на Modelica](image/lab4_2_pp.png){#fig:011 width=50%}
...
![Случай 3. Решение, полученное на Modelica](image/lab4_3.png){#fig:012 width=50%}

## Выполнение на Modelica

![Случай 3. Фазовый портрет, полученный на Modelica](image/lab4_3_pp.png){#fig:013 width=50%}
