...
![Случай 1.  График зависимости x от y, полученный на Julia](image/lab5_1_1.png){#fig:003 width=50%}
...
![Случай 1. Решение, полученное на Modelica](image/lab5_1_2.png){#fig:005 width=50%}
...
![Случай 1. График зависимости x от y, полученный на Modelica](image/lab5_1_1.png){#fig:006 width=50%}
