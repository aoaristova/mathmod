...
![Рисунок 2. Установка OpenModelica.](image/2.png){#fig:002 width=35%}
...
![Рисунок 8. Полученный с помощью Julia результат для второго случая.](image/lab03_2.png){#fig:008 width=50%}
